                                ...
                                <table class="dbkit-table">
                                    ...
                                    <tr>
                                        <td class="mv-icon"><img
                                                src="{{ asset('backend/images/icon/market-value/icon1.png') }}"
                                                alt="icon">
                                        </td>
                                        <td class="coin-name">Dashcoin</td>
                                        <td class="buy">30% <img
                                                src="{{ asset('backend/images/icon/market-value/triangle-down.png') }}"
                                                alt="icon">
                                        </td>
                                        <td class="sell">20% <img
                                                src="{{ asset('backend/images/icon/market-value/triangle-up.png') }}"
                                                alt="icon">
                                        </td>
                                        <td class="trends"><img
                                                src="{{ asset('backend/images/icon/market-value/trends-up-icon.png') }}"
                                                alt="icon">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="mv-icon">
                                            <div class="mv-icon"><img
                                                    src="{{ asset('backend/images/icon/market-value/icon2.png') }}"
                                                    alt="icon">
                                            </div>
                                        </td>
                                        ...
                                        <td class="trends"><img
                                                src="{{ asset('backend/images/icon/market-value/trends-down-icon.png') }}"
                                                alt="icon"></td>
                                        <td class="attachments">$ 56746,857</td>
                                        <td class="stats-chart">
                                    ...
                                    <tr>
                                        <td class="mv-icon">
                                            <div class="mv-icon"><img
                                                    src="{{ asset('backend/images/icon/market-value/icon3.png') }}"
                                                    alt="icon">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="mv-icon">
                                            <div class="mv-icon"><img
                                                    src="{{ asset('backend/images/icon/market-value/icon4.png') }}"
                                                    alt="icon">
                                            </div>
                                        </td>
                        ...
                        <div class="cripto-live mt-5">
                            <ul>
                                <li>
                                    ...
                                    Bitcoin<span><i class="fa fa-long-arrow-up"></i>$876909.00</span></li>
                                <li>
                                    <div class="icon l">l</div>
                                    Litecoin<span><i class="fa fa-long-arrow-up"></i>$29780.00</span></li>
                                <li>
                                    <div class="icon d">d</div>
                                    Dashcoin<span><i class="fa fa-long-arrow-up"></i>$13276.00</span></li>
                                <li>
                                    <div class="icon b">b</div>
                                    Bitcoindash<span><i class="fa fa-long-arrow-down"></i>$5684.890</span></li>
                                <li>
                                    <div class="icon e">e</div>
                                    Euthorium<span><i class="fa fa-long-arrow-down"></i>$3890.98</span></li>
                                <li>
                                    <div class="icon t">b</div>
                                    Tcoin<span><i class="fa fa-long-arrow-up"></i>$750.789</span></li>
                                <li>
                                    <div class="icon b">b</div>
                                    Bitcoin<span><i class="fa fa-long-arrow-up"></i>$325.037</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="d-sm-flex justify-content-between align-items-center">
                            ...
                            <div class="trd-history-tabs">
                                <ul class="nav" role="tablist">
                                    <li>
                                        <a class="active" data-toggle="tab" href="#buy_order" role="tab">Buy
                                            Order</a>
                                    </li>
                                    <li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="letest-news mt-5">
                            <div class="single-post mb-xs-40 mb-sm-40">
                                <div class="lts-thumb">
                                    <img src="{{ asset('backend/images/blog/post-thumb1.jpg') }}" alt="post thumb">
                                </div>
                            ...
                            <div class="single-post">
                                <div class="lts-thumb">
                                    <img src="{{ asset('backend/images/blog/post-thumb2.jpg') }}" alt="post thumb">
                                </div>
                                <div class="lts-content">
                                    <span>Admin Post</span>
                                    <h2><a href="blog.html">Sed ut perspiciatis unde omnis iste.</a></h2>
